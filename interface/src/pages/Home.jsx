...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#001D4A] font-sans">
      ...
      {/* HERO SECTION */}
      <section className="bg-[#FFFDF9] py-12 md:py-20 lg:py-24">
        {/* Added wrapper here to match the max-w-6xl mx-auto width of the other sections */}
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 max-w-xl">
            ...
            <button className="bg-[#001D4A] text-white text-sm font-medium px-6 py-3 rounded-full shadow-md hover:bg-opacity-90 transition-all cursor-pointer">
              Explore club
            </button>
          </div>
          ...
          {featuredClubs.map((club) => (
            <div key={club.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md border border-gray-100 flex flex-col transition-all">
              ...
              <div className="p-5 flex-1 flex flex-col items-start">
                ...
                <button className="w-full mt-auto border border-gray-200 hover:border-[#001D4A] hover:bg-[#001D4A] hover:text-white text-gray-700 text-xs font-semibold py-2.5 rounded-full transition-all text-center cursor-pointer">
                  View Details
                </button>
              </div>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20">
        <div className="bg-[#001D4A] text-white rounded-[2rem] p-8 md:p-12 shadow-lg">
          <div className="mb-8">
            ...
            <p className="text-blue-200 opacity-80 text-xs mt-1">Mark your calendars for this week's events.</p>
          </div>
